        ...
        <div class="card-container">
            <div id="players" class="listar-figurinhas row">
                ...
                <div class="col-sm-6 col-md-4">
                    ...
                    <!-- Substitua as interrogações por "<?= $player['id'] ?>" -->
                    <!-- Isso vai gerar um link para cada time especificando-se o ID -->
                    <a href="http://localhost:8080/teams/<?= $player['id'] ?>">
                        
                        <!-- Substitua as interrogações por "cor" -->
                        <div class="profile-card-5"  style="background: <?= $player['cor'] ?>">

                            <div class="row">
                                <div class="col-7">
                                    
                                    <!-- Substitua as interrogações por "selecao" -->
                                    <div class="profile-name"><?= $player['selecao'] ?></div>

                                    <!-- Substitua as interrogações por "abrev" -->
                                    <div class="profile-abrev"><?= $player['abrev'] ?></div>

                                    <div class="profile-group">
                                        <!-- Substitua as interrogações por "grupo" -->
                                        <span>grupo </span> <?= $player['grupo'] ?>
                                    </div>
                                </div>
                                <div class="col-5">
